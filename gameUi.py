...
class Plane(Base):
    ...
    def __crate_images(self):
        self.bomb_list.append(pygame.image.load("./plane/hero_blowup_n1.png"))
        self.bomb_list.append(pygame.image.load("./plane/hero_blowup_n2.png"))
        self.bomb_list.append(pygame.image.load("./plane/hero_blowup_n3.png"))
        self.bomb_list.append(pygame.image.load("./plane/hero_blowup_n4.png"))
...
if __name__ == "__main__":
    ...
    background = pygame.image.load("./planeImage/background.png").convert()
